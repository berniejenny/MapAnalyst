...
/**
 * Computes and writes the errors for each measured control point in
 * the specified GeoSet.
 */
     ...
     */
     public void analyzeMap () {
        ...
        for(int i = 0; i < transformedSourcePoints.length; i++){
            ...
            final VectorSymbol symbol = r > 3. * sigma0 ?
                this.outliersVectorSymbol : this.vectorSymbol;
            ...
            // store radius
            circles[i] = new Circle (destPointX, destPointY, r);
        }
        ...
        for (int i = circles.length - 1; i >= 0 ; --i){
            ...
            // use special symbol for outliers
            final VectorSymbol symbol = circle.dist > sigma0 ?
                this.outliersVectorSymbol : this.vectorSymbol;
