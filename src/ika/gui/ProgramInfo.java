 ...
 */
public class ProgramInfo extends javax.swing.JDialog {
     ...
     */
    private ProgramInfo(Frame owner) {
        super(owner);
        initComponents();

        // name and version
        nameLabel.setText(ApplicationInfo.getApplicationName());
        versionLabel.setText(ApplicationInfo.getApplicationVersion());

        // copyright
        copyrightLabel.setText(ApplicationInfo.getCopyright());

        // homepage
        homepageButton.setText(ApplicationInfo.getHomepage());

        // operating system
        String osString = "Operating System: " + System.getProperty("os.name")
                + " " + System.getProperty("os.version");
        osInfoLabel.setText(osString);
        ...
        javaInfoLabel.setText(javaString);
    }
