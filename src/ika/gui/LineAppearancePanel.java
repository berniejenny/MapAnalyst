...
public class LineAppearancePanel extends ika.gui.TransparentPanel {
    ...
    private static final float[] LINE_WIDTHS = {0.25f, 0.5f, 1.f, 1.5f, 2.f, 3.f, 5.f, 10.f};
    ...
    public LineAppearancePanel() {
        ...
        // hide dashed lines option, which tends to crash/stall the VM
        // https://bugs.openjdk.java.net/browse/JDK-7018932
        // http://bugs.java.com/view_bug.do?bug_id=5054725
    ...
    public VectorSymbol getVectorSymbol() {
        ...
        return vectorSymbol.copy();
    }

    public void setVectorSymbol(VectorSymbol vectorSymbol) {
        this.vectorSymbol = vectorSymbol.copy();
